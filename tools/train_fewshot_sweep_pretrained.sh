#"6000 6000 1000 1000 16000 16000"        #1h
                   # "3000 3000 500 500 8000 8000"           #2h
                   # "1200 1200 200 200 3200 3200")           #4h
SUBSAMPLEFACTORSS=("600 600 100 100 1600 1600"             #8h
                   "300 300 50 50 800 800"                   
                   "120 120 20 20 320 320"
                   "60 60 10 10 160 160")

#pretrained models checkpoint paths
#source -> target           DA strategy                             model name              cfg name                            epoch
# avlrooftop -> avltruck:   DA_pvrcnnpp50_4w_ROS_RBUS075_POSTSN     epoch 50
# zod -> avltruck           DA_pvrcnnpp50_4w_ST++                   epochs 21
# avltruck -> avlrooftop:   DA_pvrcnnpp50_4w_ROS_POSTSN_RBDS        pvrcnnpp_ros_rbds       D6_50epochs                         epoch 50
# zod -> avlrooftop         DA_pvrcnnpp50_4w_ROS_POSTSN_RBDS        epoch 50
# avltruck -> zod:          DA_pvrcnnpp50_4w_ST++_GACE              pvrcnnpp_ST++zod_gace   D16_30epochs_STzod_ft_D6_50epochs   epoch 3
# avlrooftop -> zod         DA_pvrcnnpp50_4w_ROS_RBUS075_POSTSN     epoch 50
...
PRETRAINED_CKPTS=(
                "/home/cgriesbacher/thesis/3DTrans/output/avlrooftop_models/pvrcnnpp_ros_rbus075/D1_50epochs/ckpt/checkpoint_epoch_50.pth"
                "/home/cgriesbacher/thesis/3DTrans/output_okeanos/zod_models/pvrcnnpp_ST++truck_1_lr003/D16_30epochs_STzod_ft_D6_50epochs_4/ckpt/checkpoint_epoch_21.pth"
                "/home/cgriesbacher/thesis/3DTrans/output/avltruck_models/pvrcnnpp_ros_rbds/D6_50epochs/ckpt/checkpoint_epoch_50.pth"
                "/home/cgriesbacher/thesis/3DTrans/output/zod_models/pvrcnnpp_ros_rbds/D16_50epochs_rbds0.5/ckpt/checkpoint_epoch_50.pth"
                "/home/cgriesbacher/thesis/3DTrans/output/avltruck_models/pvrcnnpp_ST++zod_gace/D16_30epochs_STzod_ft_D6_50epochs/ckpt/checkpoint_epoch_3.pth"
                "/home/cgriesbacher/thesis/3DTrans/output/avlrooftop_models/pvrcnnpp_ros_rbus075/D1_50epochs/ckpt/checkpoint_epoch_50.pth"
                )
...
for i in "${!SUBSAMPLEFACTORSS[@]}"; do
    ...
    for i in "${!DATASETS[@]}"; do
        ...
        EXTRA_TAG=D${SUBSAMPLEFACTOR}_50epochs_ft_${PRETRAINED_CFG_TAG}_DA${EXPERIMENT_IDX}
